export default function NewAppSkeleton() {
  return (
    <div class="flex h-screen">
      <div class="px-4 py-2 bg-gray-200 bg-indigo-600 lg:w-1/8">
        <svg
        ...
        <div class="hidden lg:block">
          <div class="my-2 mb-6">
            <h1 class="text-2xl font-bold text-white">Instantly ka Baap</h1>
          </div>
          <ul>
